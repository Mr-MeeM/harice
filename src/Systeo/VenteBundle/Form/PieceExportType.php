...
class PieceExportType extends AbstractType
{
    /**
     * {@inheritdoc}
     */
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $builder
                ...
                ->add('tier', EntityType::class, array(
                    ...
                    'label' => false,
                    'required' => false))
                ->add('pieceExportLignes', CollectionType::class, array(
                        'entry_type' => PieceExportLigneType::class,
                        'allow_add'    => true,
                        'allow_delete' => true,
                        'by_reference' => false,
                        'entry_options'=>[
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'Systeo\VenteBundle\Entity\PieceExport'
        ));
